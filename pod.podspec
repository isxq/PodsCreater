#
#  Be sure to run `pod spec lint __ProjectName__.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "isxq" => "shen_x_q@163.com" }
  ...
  s.source_files  = "__ProjectName__/PodsDic/Classes/**/*.{h,m,swift}"
  ...
  # s.resource  = "icon.png"
  s.resources = "__ProjectName__/PodsDic/Resources/**/*"
